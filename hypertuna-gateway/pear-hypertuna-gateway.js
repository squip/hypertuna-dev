...
} = require('./pear-hypertuna-gateway-client');
...
const options = {
  key: fs.readFileSync('/etc/letsencrypt/live/hypertuna.com/privkey.pem'),
  cert: fs.readFileSync('/etc/letsencrypt/live/hypertuna.com/fullchain.pem')
};
